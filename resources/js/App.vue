<template>
    <div class="container m-auto">
        ...
        <div class="antialiased bg-gray-100 text-gray-600">
            <router-view @is-loading="toggleLoader"></router-view>
        </div>
        <div v-if="loader" class="bg-gray-600 fixed left-0 top-0 h-full w-full bg-opacity-40 flex justify-center items-center">
